...
class SubscriptionManagementTest(object):
    def subDeviceBusinessData(self):
        ...
        sdbdInDTO.callbackUrl = "https://49.4.92.191:8743/v1.0.0/messageReceiver"
        return sdbdInDTO

    def subDeviceManagementData(self):
        sdmdInDTO = SubDeviceManagementDataInDTO()
        sdmdInDTO.notifyType = "swUpgradeStateChangeNotify"
        sdmdInDTO.callbackurl = "https://49.4.92.191:8743/v1.0.0/messageReceiver"
        return sdmdInDTO

    def queryBatchSubscriptions(self):
        qbsInDTO = QueryBatchSubInDTO()
        qbsInDTO.appId = "A_93xVRJbrZRrl5fjqP5W6CTxnMa"
    ...
    def deleteBatchSubscriptions(self):
        ...
        dbsInDTO.appId = "A_93xVRJbrZRrl5fjqP5W6CTxnMa"
        dbsInDTO.callbackUrl = "https://49.4.92.191:8743/v1.0.0/messageReceiver"
